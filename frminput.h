...
private:
    ...
    QString currentCaps;            //当前大小写类型
    QString currentNum;             //当前键盘类型
    QString currentChar;            //当前键盘类型
    void changeType(QString type);  //改变输入法类型
    void changeKey(QString type);   //改变键盘类型
    void changeKey2(QString type);  //改变键盘类型
    void changeLetter(bool isUpper);//改变字母大小写

    QString QSlabPY;                //存储PY字符串**
